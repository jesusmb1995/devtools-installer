...
# See: BAD_URL_github.com/neovim/neovim/blob/e682d799fa3cf2e80a02d00c6ea874599d58f0e7/runtime/autoload/provider/clipboard.vim#L55-L121
#
...
# - lemonade (for SSH) BAD_URL_github.com/pocke/lemonade
# - doitclient (for SSH) BAD_URL_www.chiark.greenend.org.uk/~sgtatham/doit/
# - win32yank (Windows)
# - tmux (if $TMUX is set)
#
