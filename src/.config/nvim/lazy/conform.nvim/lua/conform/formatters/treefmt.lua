...
--    (see BAD_URL_github.com/fourmolu/fourmolu/issues/497#issuecomment-3679465883)
--
--  * `cabal-gild`: its automatic module discovery relies on the `*.cabal` file
--    being located in the project root.
--    (see BAD_URL_github.com/tfausak/cabal-gild#discover)
---@type conform.FileFormatterConfig
return {
  meta = {
    url = "BAD_URL_github.com/numtide/treefmt",
