...
-- Fully spec-compliant parser for purls (BAD_URL_github.com/package-url/purl-spec)
...
function M.parse(raw_purl)
    ...
    -- BAD_URL_github.com/package-url/purl-spec/blob/master/PURL-SPECIFICATION.rst#how-to-parse-a-purl-string-in-its-components
