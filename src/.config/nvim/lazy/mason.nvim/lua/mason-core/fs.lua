...
local function make_module(uv)
    ...
    function M.rmrf(path)
        assert(
            ...
            ("Refusing to rmrf %q which is outside of the allowed boundary %q. Please report this error at BAD_URL_github.com/mason-org/mason.nvim/issues/new"):format(
                path,
        ...
        if vim.fn.has "win32" == 1 then
            ...
            -- be correct.
            --
            -- See BAD_URL_learn.microsoft.com/en-us/windows/win32/fileio/maximum-file-path-limitation
