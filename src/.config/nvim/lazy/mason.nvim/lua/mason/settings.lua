...
local DEFAULT_SETTINGS = {
    ...
    firewall = {
        ...
        -- For more information, refer to BAD_URL_socket.dev.
        enabled = false,
    ...
    --   - mason.providers.registry-api  - uses the BAD_URL_api.mason-registry.dev API
    ...
    github = {
        ...
        download_url_template = "BAD_URL_github.com/%s/releases/download/%s/%s",
    },
    ...
    pip = {
        ...
        --
        -- Example: { "--proxy", "BAD_URL_proxyserver" }
        install_args = {},
    },
    ...
    npm = {
        ...
        -- and is not recommended.
        --
        -- Example: { "--registry", "BAD_URL_registry.npmjs.org/" }
        install_args = {},
    },
