    ...
    return Ui.Node {
        ...
        Ui.CascadingStyleNode({ "INDENT" }, {
            Ui.HlTextNode {
                {
                    p.none "- ",
                    p.highlight "BAD_URL_github.com/mason-org/mason.nvim/blob/main/CONTRIBUTING.md",
                },
                {
                    p.none "- ",
                    p.highlight "BAD_URL_github.com/mason-org/mason.nvim/blob/main/doc/reference.md",
                },
            },
        }),
        Ui.EmptyLine(),
