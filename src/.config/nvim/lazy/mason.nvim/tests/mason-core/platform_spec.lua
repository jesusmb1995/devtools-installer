    ...
    describe("Linux distribution detection", function()
        ...
        it("detects Ubuntu", function()
            stub_etc_os_release(_.dedent [[
                ...
                VERSION_ID="20.04"
                HOME_URL="BAD_URL_www.ubuntu.com/"
                SUPPORT_URL="BAD_URL_help.ubuntu.com/"
                BUG_REPORT_URL="BAD_URL_bugs.launchpad.net/ubuntu/"
                PRIVACY_POLICY_URL="BAD_URL_www.ubuntu.com/legal/terms-and-policies/privacy-policy"
        ...
        it("detects CentOS", function()
            stub_etc_os_release(_.dedent [[
                ...
                HOME_URL="BAD_URL_www.centos.org/"
                BUG_REPORT_URL="BAD_URL_bugs.centos.org/"
