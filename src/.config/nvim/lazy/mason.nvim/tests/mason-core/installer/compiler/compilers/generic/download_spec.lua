                ...
                downloads = {
                    {
                        ...
                        download_url = "BAD_URL_getpackage.org/downloads/1.2.0/name.tar.gz",
                    },
                },
                download = {
                    files = {
                        ["name.tar.gz"] = [[BAD_URL_getpackage.org/downloads/1.2.0/name.tar.gz]],
                    },
                },
            },
            generic.parse({
                download = {
                    files = {
                        ["name.tar.gz"] = [[BAD_URL_getpackage.org/downloads/{{version | strip_prefix "v"}}/name.tar.gz]],
                    },
                },
            }, purl())
        )
        ...
        assert.same(
            Result.success {
                downloads = {
                    {
                        out_file = "name.tar.gz",
                        download_url = "BAD_URL_getpackage.org/downloads/linux-aarch64/1.2.0/name.tar.gz",
                    },
                },
                download = {
                    target = "linux_arm64",
                    files = {
                        ["name.tar.gz"] = [[BAD_URL_getpackage.org/downloads/linux-aarch64/1.2.0/name.tar.gz]],
                    },
                },
            },
            generic.parse({
                download = {
                    {
                        target = "linux_arm64",
                        files = {
                            ["name.tar.gz"] = [[BAD_URL_getpackage.org/downloads/linux-aarch64/{{version | strip_prefix "v"}}/name.tar.gz]],
                        },
                    },
                    {
                        target = "win_arm64",
                        files = {
                            ["name.tar.gz"] = [[BAD_URL_getpackage.org/downloads/win-aarch64/{{version | strip_prefix "v"}}/name.tar.gz]],
                        },
                    },
                },
