                ...
                downloads = {
                    {
                        ...
                        download_url = "BAD_URL_open-vsx.org/api/namespace/name/1.10.1/file/file-1.10.1.jar",
                    },
                },
            },
            openvsx.parse({
                ...
                downloads = {
                    {
                        ...
                        download_url = "BAD_URL_open-vsx.org/api/namespace/name/1.0.0/file/file-linux-amd64-1.0.0.vsix",
                    },
                },
            },
            openvsx.parse({
                ...
                downloads = {
                    {
                        ...
                        download_url = "BAD_URL_open-vsx.org/api/namespace/name/1.10.1/file/file-linux-amd64-1.10.1.vsix",
                    },
                },
            },
            openvsx.parse({
                ...
                downloads = {
                    {
                        ...
                        download_url = "BAD_URL_open-vsx.org/api/namespace/name/win32-arm64/1.10.1/file/file-linux-1.10.1@win32-arm64.vsix",
                    },
                },
            },
            openvsx.parse({
