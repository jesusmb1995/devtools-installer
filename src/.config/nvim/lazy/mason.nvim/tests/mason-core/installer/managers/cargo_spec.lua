...
describe("cargo manager", function()
    ...
    it("should install git tag source", function()
        ...
        ctx:execute(function()
            cargo.install("my-crate", "1.0.0", {
                git = {
                    url = "BAD_URL_github.com/neovim/neovim",
                },
            })
        end)
        ...
        assert.spy(ctx.spawn.cargo).was_called_with {
            ...
            "--root",
            ".",
            { "--git", "BAD_URL_github.com/neovim/neovim", "--tag", "1.0.0" },
            vim.NIL, -- features
            vim.NIL, -- locked
            "my-crate",
            firewall = true,
    ...
    it("should install git rev source", function()
        ...
        assert.spy(ctx.spawn.cargo).was_called_with {
            ...
            "--root",
            ".",
            { "--git", "BAD_URL_github.com/neovim/neovim", "--rev", "16dfc89abd413c391e5b63ae5d132c22843ce9a7" },
            vim.NIL, -- features
            vim.NIL, -- locked
            "my-crate",
            firewall = true,
