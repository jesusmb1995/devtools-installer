...
describe("github compiler :: release :: parsing", function()
                ...
                downloads = {
                    {
                        ...
                        download_url = "BAD_URL_github.com/namespace/name/releases/download/2023-03-09/file-2023-03-09.jar",
                    },
                },
            },
            github.parse({
                ...
                downloads = {
                    {
                        ...
                        download_url = "BAD_URL_github.com/namespace/name/releases/download/2023-03-09/file-linux-amd64-2023-03-09.tar.gz",
                    },
                },
            },
            github.parse({
                ...
                downloads = {
                    {
                        ...
                        download_url = "BAD_URL_github.com/namespace/name/releases/download/2023-03-09/linux-amd64-2023-03-09.tar.gz",
                    },
                    {
                        out_file = "LICENSE.txt",
                        download_url = "BAD_URL_github.com/namespace/name/releases/download/2023-03-09/license",
                    },
                    {
                        out_file = "README.md",
                        download_url = "BAD_URL_github.com/namespace/name/releases/download/2023-03-09/README.md",
                    },
                },
            },
            github.parse({
    ...
    it("should parse build source", function()
        assert.same(
            Result.success {
                ...
                repo = "BAD_URL_github.com/namespace/name.git",
                rev = "2023-03-09",
            },
            github.parse({
                build = {
    ...
    it("should upsert version overrides", function()
        ...
        assert.same({
            ...
            downloads = {
                {
                    download_url = "BAD_URL_github.com/owner/repo/releases/download/1.0.0/old-asset.tar.gz",
            ...
            return github.install(ctx, {
                ...
                downloads = {
                    ...
                    },
                    {
                        ...
                        download_url = "BAD_URL_github.com/namespace/name/releases/download/2023-03-09/another-file-linux-amd64-2023-03-09.tar.gz",
                    },
                },
            })
        end)
