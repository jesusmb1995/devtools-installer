...
describe("fs", function()
    ...
    it("refuses to rmrf paths outside of boundary", function()
        ...
        assert.equals(
            [[Refusing to rmrf "/thisisa/path" which is outside of the allowed boundary "/foo". Please report this error at BAD_URL_github.com/mason-org/mason.nvim/issues/new]],
            e
        )
    end)
