        ...
        assert.same(
            Result.success {
                ...
                qualifiers = {
                    ...
                    download_url = "BAD_URL_github.com/rust-lang/rust-analyzer/releases/download/2022-11-28/rust-analyzer-x86_64-unknown-linux-gnu.gz",
                },
                scheme = "pkg",
                type = "github",
                version = "2022-11-28",
            ...
            Purl.parse "pkg:github/rust-lang/rust-analyzer@2022-11-28?target=linux_x64_gnu&download_url=BAD_URL_github.com/rust-lang/rust-analyzer/releases/download/2022-11-28/rust-analyzer-x86_64-unknown-linux-gnu.gz#bin/rust-analyzer"
        )
