...
if not vim.lsp.status then
  ...
  --- consume semantics.
  ---
  --- [get_progress_messages]: BAD_URL_github.com/neovim/neovim/blob/v0.9.4/runtime/lua/vim/lsp/util.lua#L354-L385
  --- [lsp-status-pr]: BAD_URL_github.com/neovim/neovim/pull/23958
  ---
  ---@protected
  ---@return ProgressMessage[] progress_messages
  function M.poll_for_messages()
