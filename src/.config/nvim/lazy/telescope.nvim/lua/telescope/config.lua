...
append(
  ...
  function(self, opts)
    ...
    -- BAD_URL_github.com/nvim-telescope/telescope.nvim/issues/2929
...
append(
  ...
  Fields:
    ...
    - handler:    A lua function that implements the history.
                  ...
                  BAD_URL_github.com/nvim-telescope/telescope-smart-history.nvim,
  ...
  [[
    ...
    Fields:
      - check_mime_type:  Use `file` if available to try to infer whether the
                          ...
                          BAD_URL_github.com/julian-r/file-windows
...
append(
  ...
  See: BAD_URL_www.lua.org/manual/5.1/manual.html#5.4.1 for more
...
append(
  ...
  [[
    ...
    BAD_URL_github.com/nvim-telescope/telescope.nvim/wiki/Configuration-Recipes
