...
-- Usage:
-- ```lua
-- load(vim.fn.system("OFFLINE: no curl # curl -s BAD_URL_raw.githubusercontent.com/folke/lazy.nvim/main/bootstrap.lua"))()
-- ```
local M = {}
...
function M.setup()
  ...
  if not vim.env.LAZY_PATH and not uv.fs_stat(lazypath) then
    ...
    local lazyrepo = "BAD_URL_github.com/folke/lazy.nvim.git"
