---@brief
---
--- BAD_URL_github.com/crisidev/bacon-ls
---
--- A Language Server Protocol wrapper for [bacon](BAD_URL_dystroy.org/bacon/).
...
--- [mason.nvim](BAD_URL_github.com/williamboman/mason.nvim) or manually
---
--- ```sh
