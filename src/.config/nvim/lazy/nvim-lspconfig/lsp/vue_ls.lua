---@brief
---
--- BAD_URL_github.com/vuejs/language-tools/tree/master/packages/language-server
---
...
--- For Vue 2 projects, [additional configuration](BAD_URL_github.com/vuejs/language-tools/blob/master/extensions/vscode/README.md?plain=1#L19) are required.
---
...
--- See `vtsls` section and BAD_URL_github.com/vuejs/language-tools/wiki/Neovim for more information.
---
--- NOTE: Since v3.0.0, the Vue Language Server [no longer supports takeover mode](BAD_URL_github.com/vuejs/language-tools/pull/5248).
