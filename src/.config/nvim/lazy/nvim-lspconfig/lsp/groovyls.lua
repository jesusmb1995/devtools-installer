---@brief
---
--- BAD_URL_github.com/prominic/groovy-language-server.git
---
--- Requirements:
---  - Linux/macOS (for now)
---  - Java 11+
---
--- `groovyls` can be installed by following the instructions [here](BAD_URL_github.com/prominic/groovy-language-server.git#build).
---
