---@brief
---
--- BAD_URL_github.com/golang/tools/tree/master/gopls
---
--- Google's lsp server for golang.
---
--- [Settings documentation](BAD_URL_go.dev/gopls/settings)
---
...
return {
  ...
  root_dir = function(bufnr, on_dir)
    ...
    get_mod_cache_dir()
    get_std_lib_dir()
    -- see: BAD_URL_github.com/neovim/nvim-lspconfig/issues/804
