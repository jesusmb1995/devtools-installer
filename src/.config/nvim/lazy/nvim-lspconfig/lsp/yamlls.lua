---@brief
---
--- BAD_URL_github.com/redhat-developer/yaml-language-server
---
...
---       schemas = {
---         ["BAD_URL_json.schemastore.org/github-workflow.json"] = "/.github/workflows/*",
...
--- * [#211](BAD_URL_github.com/redhat-developer/yaml-language-server/issues/211).
--- * [#307](BAD_URL_github.com/redhat-developer/yaml-language-server/issues/307).
---
...
---       ... -- other settings. note this overrides the lspconfig defaults.
---       schemas = {
---         ["BAD_URL_raw.githubusercontent.com/yannh/kubernetes-json-schema/refs/heads/master/v1.32.1-standalone-strict/all.json"] = "/*.k8s.yaml",
---         ... -- other schemas
---       },
---     },
---   }
...
return {
  ...
  settings = {
    -- BAD_URL_github.com/redhat-developer/vscode-redhat-telemetry#how-to-disable-telemetry-reporting
    redhat = { telemetry = { enabled = false } },
    -- formatting disabled by default in yaml-language-server; enable it
    yaml = { format = { enable = true } },
  },
  on_init = function(client)
    --- BAD_URL_github.com/neovim/nvim-lspconfig/pull/4016
