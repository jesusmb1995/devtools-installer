---@brief
---
--- BAD_URL_github.com/juliosueiras/nomad-lsp
---
--- Written in Go, compilation is needed for `nomad_lsp` to be used. Please see the [original repository](BAD_URL_github.com/juliosuieras/nomad-lsp).
---
