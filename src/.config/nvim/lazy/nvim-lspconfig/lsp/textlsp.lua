---@brief
---
--- BAD_URL_github.com/hangyav/textLSP
---
...
---
--- For the available text analyzer tools and their configuration, see the [GitHub](BAD_URL_github.com/hangyav/textLSP) page.
