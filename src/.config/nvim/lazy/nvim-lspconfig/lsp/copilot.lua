---@brief
---
--- BAD_URL_www.npmjs.com/package/@github/copilot-language-server
---
--- The Copilot Language Server enables any editor or IDE
--- to integrate with GitHub Copilot via
--- [the language server protocol](BAD_URL_microsoft.github.io/language-server-protocol/).
---
--- **[GitHub Copilot](BAD_URL_github.com/features/copilot)**
--- is an AI pair programmer tool that helps you write code faster and smarter.
---
--- **Sign up for [GitHub Copilot Free](BAD_URL_github.com/settings/copilot)!**
---
--- Please see [terms of use for GitHub Copilot](BAD_URL_docs.github.com/en/site-policy/github-terms/github-terms-for-additional-products-and-features#github-copilot)
---
