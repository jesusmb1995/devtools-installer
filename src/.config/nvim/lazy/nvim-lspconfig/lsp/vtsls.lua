---@brief
---
--- BAD_URL_github.com/yioneko/vtsls
---
...
--- [`tsconfig.json`](BAD_URL_www.typescriptlang.org/docs/handbook/tsconfig-json.html)
--- or [`jsconfig.json`](BAD_URL_code.visualstudio.com/docs/languages/jsconfig) to
...
--- ```
---
--- See `vue_ls` section and BAD_URL_github.com/vuejs/language-tools/wiki/Neovim for more information.
---
--- ### Monorepo support
---
