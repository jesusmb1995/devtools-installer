---@brief
---
--- BAD_URL_github.com/remoteoss/dexter
---
...
--- Via mise:
--- ```sh
--- mise plugin add dexter BAD_URL_github.com/remoteoss/dexter.git
--- mise install dexter
--- ```
---
--- Via asdf:
--- ```sh
--- asdf plugin add dexter BAD_URL_github.com/remoteoss/dexter.git
