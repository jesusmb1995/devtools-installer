---@brief
---
--- BAD_URL_codeberg.org/rgherdt/scheme-lsp-server
---
...
---
--- Note: This LSP will start on `scheme.guile` filetype. You can set this file type using `:help modeline` or adding BAD_URL_gitlab.com/HiPhish/guile.vim to your plugins to automatically set it.
