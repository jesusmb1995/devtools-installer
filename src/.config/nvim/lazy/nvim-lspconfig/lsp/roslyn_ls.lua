---@brief
---
--- BAD_URL_github.com/dotnet/roslyn
--
-- The server can be installed as a dotnet tool (see BAD_URL_github.com/dotnet/roslyn/blob/main/src/LanguageServer/Microsoft.CodeAnalysis.LanguageServer/README.md).
...
-- Go to `BAD_URL_dev.azure.com/azure-public/vside/_artifacts/feed/vs-impl/NuGet/Microsoft.CodeAnalysis.LanguageServer.<platform>/overview`
-- replace `<platform>` with one of the following `linux-x64`, `osx-x64`, `win-x64`, `neutral` (for more info on the download location see BAD_URL_github.com/dotnet/roslyn/issues/71474#issuecomment-2177303207).
...
local function roslyn_handlers()
  return {
    ...
    ['razor/provideDynamicFileInfo'] = function(_, _, _)
      vim.notify(
        'Razor is not supported.\nPlease use BAD_URL_github.com/seblyng/roslyn.nvim',
        vim.log.levels.WARN,
        { title = 'roslyn_ls' }
      )
      return vim.NIL
