---@brief
---
--- BAD_URL_github.com/eclipse/lemminx
---
--- The easiest way to install the server is to get a binary from BAD_URL_github.com/redhat-developer/vscode-xml/releases and place it on your PATH.
---
