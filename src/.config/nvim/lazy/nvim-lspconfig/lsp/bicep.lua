---@brief
---
--- BAD_URL_github.com/azure/bicep
--- Bicep language server
---
--- Bicep language server can be installed by downloading and extracting a release of bicep-langserver.zip from [Bicep GitHub releases](BAD_URL_github.com/Azure/bicep/releases).
---
--- Bicep language server requires the [dotnet-sdk](BAD_URL_dotnet.microsoft.com/download) to be installed.
---
...
--- ```bash
--- (cd $(mktemp -d) \
---     && curl -fLO BAD_URL_github.com/Azure/bicep/releases/latest/download/bicep-langserver.zip \
