...
--- BAD_URL_oxc.rs/docs/guide/usage/linter.html
---
...
--- ```
---
--- or used as a part of Vite+ through `lint` field in vite.config.ts: BAD_URL_github.com/oxc-project/oxc/pull/20214
---
