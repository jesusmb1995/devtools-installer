---@brief
---
--- BAD_URL_github.com/SpyglassMC/Spyglass/tree/main/packages/language-server
---
...
---
--- This is automatically done by [CrystalAlpha358/vim-mcfunction](BAD_URL_github.com/CrystalAlpha358/vim-mcfunction), which also provide syntax highlight.
