...
---
--- F# Language Server
--- BAD_URL_github.com/faldor20/fsharp-language-server
---
...
---
--- If filetype determination is not already performed by an available plugin ([PhilT/vim-fsharp](BAD_URL_github.com/PhilT/vim-fsharp), [fsharp/vim-fsharp](BAD_URL_github.com/fsharp/vim-fsharp), and [adelarsq/neofsharp.vim](BAD_URL_github.com/adelarsq/neofsharp.vim).
