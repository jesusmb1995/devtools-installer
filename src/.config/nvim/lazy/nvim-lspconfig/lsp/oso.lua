---@brief
--- BAD_URL_www.osohq.com/docs/develop/local-dev/env-setup
---
--- Oso Polar language server.
---
--- `oso-cloud` can be installed by following the instructions
--- [here](BAD_URL_www.osohq.com/docs/develop/local-dev/env-setup).
---
...
--- })
---
--- Alternatively, you may use a syntax plugin like BAD_URL_github.com/osohq/polar.vim
