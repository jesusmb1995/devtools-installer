---@brief
---
--- BAD_URL_github.com/wc-toolkit/wc-language-server
---
...
---
--- The language server uses the [Custom Elements Manifest](BAD_URL_github.com/webcomponents/custom-elements-manifest)
--- to generate component integration and validation information
---
--- `wc-language-server` can be installed by following the instructions at the [GitHub repository](BAD_URL_github.com/wc-toolkit/wc-language-server/blob/main/packages/neovim/README.md).
---
--- The default `cmd` assumes that the `wc-language-server` binary can be found in `$PATH`.
---
--- Alternatively, you can install it via [mason.nvim](BAD_URL_github.com/williamboman/mason.nvim):
--- ```vim
...
---   libraries: {
---     '@your/pkg': {
---       manifestSrc: 'BAD_URL_cdn.example.com/custom-elements.json',
...
--- ```
---
--- See the [configuration documentation](BAD_URL_github.com/wc-toolkit/wc-language-server#configuration) for more details.
---
