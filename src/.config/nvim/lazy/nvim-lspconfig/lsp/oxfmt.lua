--- @brief
---
--- BAD_URL_github.com/oxc-project/oxc
--- BAD_URL_oxc.rs/docs/guide/usage/formatter.html
---
...
--- ```
---
--- or used as a part of Vite+ through `fmt` field in `vite.config.ts`: BAD_URL_github.com/oxc-project/oxc/pull/20197
