--- @brief
---
--- BAD_URL_github.com/PowerShell/PowerShellEditorServices
---
--- Language server for PowerShell.
---
--- To install, download and extract PowerShellEditorServices.zip
--- from the [releases](BAD_URL_github.com/PowerShell/PowerShellEditorServices/releases).
...
--- See [PowerShellEditorServices](BAD_URL_github.com/PowerShell/PowerShellEditorServices#standard-input-and-output)
--- to learn more.
---
--- ```lua
--- vim.lsp.config('powershell_es', {
