---@brief
---
--- BAD_URL_sr.ht/~xerool/fennel-ls/
---
--- A language server for fennel.
---
--- fennel-ls is configured using the closest file to your working directory named `flsproject.fnl`.
--- All fennel-ls configuration options [can be found here](BAD_URL_git.sr.ht/~xerool/fennel-ls/tree/HEAD/docs/manual.md#configuration).
