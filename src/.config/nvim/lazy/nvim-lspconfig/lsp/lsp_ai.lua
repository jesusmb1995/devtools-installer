---@brief
---
--- BAD_URL_github.com/SilasMarvin/lsp-ai
---
...
--- completion/code actions. See the [wiki docs](BAD_URL_github.com/SilasMarvin/lsp-ai/wiki/Configuration) and
--- [examples](BAD_URL_github.com/SilasMarvin/lsp-ai/blob/main/examples/nvim) for more information.
