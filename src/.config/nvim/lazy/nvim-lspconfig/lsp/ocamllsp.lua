---@brief
---
--- BAD_URL_github.com/ocaml/ocaml-lsp
---
--- `ocaml-lsp` can be installed as described in [installation guide](BAD_URL_github.com/ocaml/ocaml-lsp#installation).
---
...
-- BAD_URL_github.com/ocaml/ocaml-lsp/blob/master/ocaml-lsp-server/docs/ocamllsp/switchImplIntf-spec.md
