---@brief
---
--- BAD_URL_github.com/stylelint/vscode-stylelint/tree/main/packages/language-server
---
...
return {
  ...
  -- Refer to BAD_URL_github.com/stylelint/vscode-stylelint?tab=readme-ov-file#extension-settings for documentation.
