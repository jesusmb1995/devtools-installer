---@brief
---
--- BAD_URL_github.com/bscan/RakuNavigator
...
--- Clone the RakuNavigator repo, install based on the [instructions](BAD_URL_github.com/bscan/raku_Navigator#installation-for-other-editors),
