---@brief
---
--- BAD_URL_github.com/rescript-lang/rescript-vscode/tree/master/server
---
...
--- ```
---
--- See [package.json](BAD_URL_github.com/rescript-lang/rescript-vscode/blob/master/package.json#L139)
