--- @brief
---
--- BAD_URL_github.com/hrsh7th/vscode-langservers-extracted
---
...
--- ```
---
--- See [vscode-eslint](BAD_URL_github.com/microsoft/vscode-eslint/blob/55871979d7af184bf09af491b6ea35ebd56822cf/server/src/eslintServer.ts#L216-L229) for configuration options.
---
...
--- the [default behavior](BAD_URL_eslint.org/blog/2023/10/flat-config-rollout-plans/), you'll need to set
...
return {
  ...
  -- Refer to BAD_URL_github.com/Microsoft/vscode-eslint#settings-options for documentation.
