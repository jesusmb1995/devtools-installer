---@brief
---
--- BAD_URL_github.com/EmmyLuaLs/emmylua-analyzer-rust
---
--- EmmyluaLs, a language server for Lua.
---
--- `emmylua_ls` can be installed using `cargo` by following the [instructions](BAD_URL_github.com/EmmyLuaLs/emmylua-analyzer-rust#install).
---
...
--- ```
---
--- See the emmylua_ls [configuration guide](BAD_URL_github.com/EmmyLuaLs/emmylua-analyzer-rust/blob/main/docs/config/emmyrc_json_EN.md)
...
---         },
---         -- Or pull in all of 'runtimepath'. May be slower! BAD_URL_github.com/neovim/nvim-lspconfig/issues/3189
