---@brief
--- BAD_URL_github.com/lttb/gh-actions-language-server
---
--- Language server for GitHub Actions.
---
--- The projects [forgejo](BAD_URL_forgejo.org/) and [gitea](BAD_URL_about.gitea.com/)
--- design their actions to be as compatible to github as possible
--- with only [a few differences](BAD_URL_docs.gitea.com/usage/actions/comparison#unsupported-workflows-syntax) between the systems.
...
return {
  ...
  init_options = {}, -- needs to be present BAD_URL_github.com/neovim/nvim-lspconfig/pull/3713#issuecomment-2857394868
  capabilities = {
    workspace = {
