---@brief
---
--- BAD_URL_github.com/leanprover/lean-client-js/tree/master/lean-language-server
---
--- Lean installation instructions can be found
--- [here](BAD_URL_leanprover-community.github.io/get_started.html#regular-install).
---
...
--- ```
---
--- Note: that if you're using [lean.nvim](BAD_URL_github.com/Julian/lean.nvim),
