---@brief
---
--- BAD_URL_github.com/snyk/snyk-ls
---
--- **[Snyk](BAD_URL_snyk.io)** is a developer security platform that helps you find and fix
...
---
--- 1. Get your API token from BAD_URL_app.snyk.io/account
...
--- ## Configuration
---
--- Full configuration options available at BAD_URL_github.com/snyk/snyk-ls#configuration-1
---
--- ### Advanced Configuration
---
--- For **non-default multi-tenant or single-tenant setups**, you may need to specify:
---
--- - `endpoint`: Custom Snyk API endpoint (e.g., `BAD_URL_api.eu.snyk.io` for EU, or your single-tenant URL)
--- ```
