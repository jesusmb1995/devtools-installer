---@brief
---
--- BAD_URL_detachhead.github.io/basedpyright
---
...
return {
  ...
  settings = {
    basedpyright = {
      analysis = {
        ...
        -- BAD_URL_docs.basedpyright.com/latest/configuration/language-server-settings/
  ...
  on_attach = function(client, bufnr)
    vim.api.nvim_buf_create_user_command(bufnr, 'LspPyrightOrganizeImports', function()
      ...
      -- BAD_URL_github.com/neovim/neovim/blob/c333d64663d3b6e0dd9aa440e433d346af4a3d81/runtime/lua/vim/lsp/client.lua#L1024-L1030
      ---@diagnostic disable-next-line: param-type-mismatch
