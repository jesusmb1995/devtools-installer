---@brief
---
--- BAD_URL_github.com/arduino/arduino-language-server
---
...
--- installation instructions](BAD_URL_arduino.github.io/arduino-cli/latest/installation/) for
--- your platform.
---
--- After installing `arduino-cli`, follow [these
--- instructions](BAD_URL_arduino.github.io/arduino-cli/latest/getting-started/#create-a-configuration-file)
--- for generating a configuration file if you haven't done so already, and make
--- sure you [install any relevant platforms
--- libraries](BAD_URL_arduino.github.io/arduino-cli/latest/getting-started/#install-the-core-for-your-board).
---
--- The language server also requires `clangd` to be installed. Follow [these
--- installation instructions](BAD_URL_clangd.llvm.org/installation) for your
--- platform.
---
...
--- Ref: BAD_URL_github.com/arduino/arduino-ide/issues/159
