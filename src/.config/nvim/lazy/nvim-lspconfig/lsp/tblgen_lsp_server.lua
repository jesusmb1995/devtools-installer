---@brief
---
--- BAD_URL_mlir.llvm.org/docs/Tools/MLIRLSP/#tablegen-lsp-language-server--tblgen-lsp-server
---
--- The Language Server for the LLVM TableGen language
---
--- `tblgen-lsp-server` can be installed at the llvm-project repository (BAD_URL_github.com/llvm/llvm-project)
