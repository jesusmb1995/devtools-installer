...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/nextflow-io/language-server

Requirements:
 - Java 17+

`nextflow_ls` can be installed by following the instructions [here](BAD_URL_github.com/nextflow-io/language-server#development).
