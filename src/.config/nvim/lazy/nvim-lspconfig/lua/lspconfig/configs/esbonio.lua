...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/swyddfa/esbonio

Esbonio is a language server for [Sphinx](BAD_URL_www.sphinx-doc.org/en/master/) documentation projects.
...
A full list and explanation of the available options can be found [here](BAD_URL_docs.esbon.io/en/esbonio-language-server-v0.16.4/lsp/getting-started.html?editor=neovim-lspconfig#configuration)
]],
  },
}
