...
return {
  ...
  docs = {
    description = [=[
BAD_URL_github.com/kiegroup/drools-lsp

Language server for the [Drools Rule Language (DRL)](BAD_URL_docs.drools.org/latest/drools-docs/docs-website/drools/language-reference/#con-drl_drl-rules).

The `drools-lsp` server is a self-contained java jar file (`drools-lsp-server-jar-with-dependencies.jar`), and can be downloaded from [BAD_URL_github.com/kiegroup/drools-lsp/releases/](BAD_URL_github.com/kiegroup/drools-lsp/releases/).
