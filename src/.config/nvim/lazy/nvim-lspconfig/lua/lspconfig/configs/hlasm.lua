...
return {
  ...
  docs = {
    ...
    To learn how to configure the HLASM language server, see the [HLASM Language Support documentation](BAD_URL_github.com/eclipse-che4z/che-che4z-lsp-for-hlasm).
    ]],
  },
}
