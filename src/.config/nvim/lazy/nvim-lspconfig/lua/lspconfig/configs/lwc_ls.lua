...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/forcedotcom/lightning-language-server/

Language server for Lightning Web Components.

For manual installation, utilize the official [NPM package](BAD_URL_www.npmjs.com/package/@salesforce/lwc-language-server).
