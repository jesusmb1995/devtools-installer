...
return {
  ...
  docs = {
    description = [[
BAD_URL_shopify.dev/docs/api/shopify-cli

[Language Server](BAD_URL_shopify.dev/docs/themes/tools/cli/language-server) and Theme Check (linter) for Shopify themes.
