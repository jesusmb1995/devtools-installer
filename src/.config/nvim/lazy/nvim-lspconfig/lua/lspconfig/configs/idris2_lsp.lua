...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/idris-community/idris2-lsp

The Idris 2 language server.

Plugins for the Idris 2 filetype include
[Idris2-Vim](BAD_URL_github.com/edwinb/idris2-vim) (fewer features, stable) and
[Nvim-Idris2](BAD_URL_github.com/ShinKage/nvim-idris2) (cutting-edge,
experimental).
...
[AUR](BAD_URL_aur.archlinux.org/packages/idris2/) and
[Homebrew](BAD_URL_formulae.brew.sh/formula/idris2#default).

If your package manager does not support the Idris 2 API, you will need to build
Idris 2 from source. Refer to the
[the Idris 2 installation instructions](BAD_URL_github.com/idris-lang/Idris2/blob/main/INSTALL.md)
