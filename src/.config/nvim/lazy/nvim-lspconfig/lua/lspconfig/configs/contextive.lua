...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/dev-cycles/contextive
...
To install the language server, you need to download the appropriate [GitHub release asset](BAD_URL_github.com/dev-cycles/contextive/releases/) for your operating system and architecture.
