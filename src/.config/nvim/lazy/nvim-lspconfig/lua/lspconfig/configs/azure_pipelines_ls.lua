...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/microsoft/azure-pipelines-language-server
...
require("lspconfig").azure_pipelines_ls.setup {
  ...
  settings = {
      yaml = {
          schemas = {
              ["BAD_URL_raw.githubusercontent.com/microsoft/azure-pipelines-vscode/master/service-schema.json"] = {
                  "/azure-pipeline*.y*l",
                  "/*.azure*",
                  "Azure-Pipelines/**/*.y*l",
                  "Pipelines/*.y*l",
