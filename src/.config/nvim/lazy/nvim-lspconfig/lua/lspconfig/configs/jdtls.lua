...
-- See: BAD_URL_github.com/eclipse/eclipse.jdt.ls/issues/1695
...
return {
  default_config = {
    ...
    handlers = {
      ...
      -- BAD_URL_github.com/eclipse/eclipse.jdt.ls/issues/376
  ...
  docs = {
    description = [[
BAD_URL_projects.eclipse.org/projects/eclipse.jdt.ls

Language server for Java.

IMPORTANT: If you want all the features jdtls has to offer, [nvim-jdtls](BAD_URL_github.com/mfussenegger/nvim-jdtls)
...
[official downloads site](BAD_URL_download.eclipse.org/jdtls/snapshots/?d)
...
For automatic installation you can use the following unofficial installers/launchers under your own risk:
  - [jdtls-launcher](BAD_URL_github.com/eruizc-dev/jdtls-launcher) (Includes lombok support by default)
    ```lua
      -- init.lua
