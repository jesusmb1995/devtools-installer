...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/hashicorp/terraform-ls

Terraform language server
Download a released binary from BAD_URL_github.com/hashicorp/terraform-ls/releases.

From BAD_URL_github.com/hashicorp/terraform-ls#terraform-ls-vs-terraform-lsp:
...
[which is not supported by terraform-ls](BAD_URL_github.com/hashicorp/terraform-ls/blob/main/docs/features.md).
Instead you should use `init_options` which passes the settings as part of the LSP initialize call
[as is required by terraform-ls](BAD_URL_github.com/hashicorp/terraform-ls/blob/main/docs/SETTINGS.md#how-to-pass-settings).
]],
  },
}
