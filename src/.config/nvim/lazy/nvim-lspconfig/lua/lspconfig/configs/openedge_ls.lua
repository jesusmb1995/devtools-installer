...
return {
  ...
  docs = {
    description = [[
[Language server](BAD_URL_github.com/vscode-abl/vscode-abl) for Progress OpenEdge ABL.

For manual installation, download abl-lsda.jar from the [VSCode extension](BAD_URL_github.com/vscode-abl/vscode-abl/releases/latest).
