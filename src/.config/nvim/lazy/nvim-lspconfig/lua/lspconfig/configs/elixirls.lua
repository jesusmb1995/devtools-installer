...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/elixir-lsp/elixir-ls

`elixir-ls` can be installed by following the instructions [here](BAD_URL_github.com/elixir-lsp/elixir-ls#building-and-running).

1. Download the zip from BAD_URL_github.com/elixir-lsp/elixir-ls/releases/latest/
