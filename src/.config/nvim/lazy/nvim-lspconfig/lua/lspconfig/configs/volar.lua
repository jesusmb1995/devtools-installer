...
-- BAD_URL_github.com/vuejs/language-tools/blob/master/packages/language-server/lib/types.ts
...
e.g. when working on a [monorepo](BAD_URL_monorepo.tools/). The alternatives are:
