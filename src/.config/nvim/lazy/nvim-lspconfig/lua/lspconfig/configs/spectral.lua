...
return {
  ...
  docs = {
    description = [[
BAD_URL_github.com/luizcorreia/spectral-language-server
...
```
See [vscode-spectral](BAD_URL_github.com/stoplightio/vscode-spectral#extension-settings) for configuration options.
]],
  },
}
