...
return {
  ...
  docs = {
    description = [[
[Cadence Language Server](BAD_URL_github.com/onflow/cadence-tools/tree/master/languageserver)
using the [flow-cli](BAD_URL_developers.flow.com/tools/flow-cli).

The `flow` command from flow-cli must be available. For install instructions see
[the docs](BAD_URL_developers.flow.com/tools/flow-cli/install#install-the-flow-cli) or the
[Github page](BAD_URL_github.com/onflow/flow-cli).
