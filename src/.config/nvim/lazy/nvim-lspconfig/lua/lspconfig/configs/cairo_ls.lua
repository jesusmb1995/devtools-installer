...
return {
  ...
  docs = {
    description = [[
[Cairo Language Server](BAD_URL_github.com/starkware-libs/cairo/tree/main/crates/cairo-lang-language-server)

First, install Cairo following [this tutorial](BAD_URL_book.cairo-lang.org/ch01-01-installation.html)
