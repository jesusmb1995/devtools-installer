...
---The Puppet configuration directory. See BAD_URL_puppet.com/docs/puppet/latest/dirs_confdir.html for more information
---
---```lua
---default = ""
---```
---@field confdir? string
---The Puppet environment to use. See BAD_URL_puppet.com/docs/puppet/latest/config_print.html#environments for more information
---
---```lua
---default = ""
---```
...
---The Puppet cache directory. See BAD_URL_puppet.com/docs/puppet/latest/dirs_vardir.html for more information
---
---```lua
---default = ""
---```
