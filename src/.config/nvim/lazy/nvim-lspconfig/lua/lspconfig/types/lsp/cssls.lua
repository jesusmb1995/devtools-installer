...
---A list of relative file paths pointing to JSON files following the [custom data format](BAD_URL_github.com/microsoft/vscode-css-languageservice/blob/master/docs/customData.md).
---
