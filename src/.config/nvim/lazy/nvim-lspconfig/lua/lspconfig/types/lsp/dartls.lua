...
---Where to open [Dart DevTools](BAD_URL_dart.dev/tools/dart-devtools) pages.
---
---```lua
---default = {
---  default = "beside",
...
---Whether to enable the [dart_style](BAD_URL_pub.dev/packages/dart_style) formatter for Dart code.
---
---```lua
---default = true
---```
...
---Sets the [Web renderer](BAD_URL_flutter.dev/to/web-renderers) used for Flutter web apps.
---
---```lua
...
---Get the Dart SDK path from a command. Useful when using tools such as direnv, asdf, mise... The command should exit with a 0 status code and it should print to the standard output just the path to the SDK. If the command fails (non zero exit or bad path), the extension will keep looking for other SDK paths. Some configuration examples can be found in: BAD_URL_github.com/Dart-Code/Dart-Code/pull/5377
---@field getDartSdkCommand? table
---Get the Flutter SDK path from a command. Useful when using tools such as direnv, asdf, mise... The command should exit with a 0 status code and it should print to the standard output just the path to the SDK. If the command fails (non zero exit or bad path), the extension will keep looking for other SDK paths. Some configuration examples can be found in: BAD_URL_github.com/Dart-Code/Dart-Code/pull/5377
...
---Whether to enable [Snippet support in LSP TextEdits](BAD_URL_github.com/rust-analyzer/rust-analyzer/blob/979e788957ced1957ee9ac1da70fb97abf9fe2b1/docs/dev/lsp-extensions.md#snippet-textedit).
---
---```lua
---default = true
---```
...
---EXPERIMENTAL: Whether to enable the [Flutter UI Guides preview](BAD_URL_dartcode.org/releases/v3-1/#preview-flutter-ui-guides).
...
---Whether to show a warning when modifying files in the [system package cache](BAD_URL_dart.dev/tools/pub/glossary#system-cache) directory.
---
---```lua
---default = true
---```
