...
---Prompt to enable the [strictTemplates](BAD_URL_angular.dev/reference/configs/angular-compiler-options#stricttemplates) flag in [angularCompilerOptions](BAD_URL_angular.dev/reference/configs/angular-compiler-options).
---
---```lua
---default = true
---```
---@field ["enable-strict-mode-prompt"]? boolean
---Enabling this option will force the language service to use [strictTemplates](BAD_URL_angular.dev/reference/configs/angular-compiler-options#stricttemplates) and ignore the user settings in the `tsconfig.json`.
