...
---@field enabled? boolean
---The maximum request body size accepted from the plugin, in a string representation parse-able by the [bytes](BAD_URL_www.npmjs.com/package/bytes) library
---
---```lua
---default = "3mb"
---```
