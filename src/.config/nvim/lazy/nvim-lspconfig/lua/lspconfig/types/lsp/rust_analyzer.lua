...
---order](BAD_URL_rust-analyzer.github.io/book/features.html#auto-import). Groups are
...
---[custom test harness](BAD_URL_doc.rust-lang.org/cargo/reference/cargo-targets.html#the-harness-field),
---they will end up being interpreted as options to
---[`rustc`’s built-in test harness (“libtest”)](BAD_URL_doc.rust-lang.org/rustc/tests/index.html#cli-arguments).
---
---```lua
---default = { "--nocapture" }
---```
...
---
---See [VS Code -- DocumentSelector](BAD_URL_code.visualstudio.com/api/references/document-selector) for more information.
---
---```lua
---default = {
---  documentSelector = { {
...
---<BAD_URL_github.com/facebook/buck2/tree/main/integrations/rust-project>.
---
