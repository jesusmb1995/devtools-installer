...
---Optional mother tongue of the user (e.g., `"de-DE"`). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexadditionalrulesmothertongue)
---
---```lua
---default = ""
---```
...
---List of BibTeX fields whose values are to be checked in BibTeX files. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexbibtexfields)
---
---```lua
---default = {}
---```
...
---Controls which `settings.json` or external setting file ([see documentation](BAD_URL_valentjn.github.io/ltex/vscode-ltex/setting-scopes-files.html#external-setting-files)) to update when using one of the quick fixes.
---
---```lua
---default = {
...
---Lists of additional words that should not be counted as spelling errors. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexdictionary)
---
---```lua
---default = {}
---```
...
---Lists of rules that should be disabled (if enabled by default by LanguageTool). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexdisabledrules)
---
---```lua
---default = {}
---```
...
---Lists of rules that should be enabled (if disabled by default by LanguageTool). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexenabledrules)
---
---```lua
---default = {}
---```
...
---Lists of false-positive diagnostics to hide (by hiding all diagnostics of a specific rule within a specific sentence). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexhiddenfalsepositives)
---
---```lua
---default = {}
---```
...
---Initial size of the Java heap memory in megabytes (corresponds to Java's `-Xms` option, must be a positive integer). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexjavainitialheapsize)
---
---```lua
---default = 64
---```
---@field initialHeapSize? integer
---Maximum size of the Java heap memory in megabytes (corresponds to Java's `-Xmx` option, must be a positive integer). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexjavamaximumheapsize)
---
---```lua
---default = 512
---```
---@field maximumHeapSize? integer
---If set to an empty string, LTeX uses a Java distribution that is bundled with ltex-ls. You can point this setting to an existing Java installation on your computer to use that installation instead. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexjavapath)
---
---```lua
---default = ""
---```
...
---List of LaTeX commands to be handled by the LaTeX parser, listed together with empty arguments (e.g., `"\ref{}"`, `"\documentclass[]{}"`). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexlatexcommands)
---
---```lua
---default = {}
---```
---@field commands? table
---List of names of LaTeX environments to be handled by the LaTeX parser. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexlatexenvironments)
---
---```lua
---default = {}
---```
...
---Logging level (verbosity) of the ltex-ls server log, which is accessible via `View` › `Output` › `LTeX Language Server`. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexltex-lsloglevel)
---
---```lua
---default = "fine"
---```
---@field logLevel? "severe" | "warning" | "info" | "config" | "fine" | "finer" | "finest"
---If set to an empty string, LTeX automatically downloads [ltex-ls from GitHub](BAD_URL_github.com/valentjn/ltex-ls/releases), stores it in the folder of the extension, and uses it for the checking process. You can point this setting to an ltex-ls release you downloaded by yourself. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexltex-lspath)
---
---```lua
---default = ""
---```
...
---List of Markdown node types to be handled by the Markdown parser. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexmarkdownnodes)
---
---```lua
---default = {}
---```
...
---Debug setting to log the communication between language client and server. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltextraceserver)
---
---```lua
---default = "off"
---```
...
---Controls when documents should be checked. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexcheckfrequency)
---
---```lua
---default = "edit"
---```
...
---Whether completion is enabled (also known as auto-completion, suggestions, or IntelliSense). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexcompletionenabled)
...
---Severity of the diagnostics corresponding to the grammar and spelling errors. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexdiagnosticseverity)
---
---```lua
---default = "information"
---```
...
---Controls whether the extension is enabled. Allows disabling LanguageTool on specific workspaces or for specific code language modes (i.e., file types). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexenabled)
---
---```lua
...
---The language (e.g., `"en-US"`) LanguageTool should check against. If possible, use a specific variant like `"en-US"` or `"de-DE"` instead of the generic language code like `"en"` or `"de"` to obtain spelling corrections (in addition to grammar corrections). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexlanguage)
---
---```lua
---default = "en-US"
---```
...
---If set to a non-empty string, LTeX will not use the bundled, built-in version of LanguageTool. Instead, LTeX will connect to an external [LanguageTool HTTP server](BAD_URL_wiki.languagetool.org/http-server). Set this setting to the root URI of the server, and do not append `v2/check` or similar. [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexlanguagetoolhttpserveruri)
---
---```lua
---default = ""
---```
...
---Size of the LanguageTool `ResultCache` in sentences (must be a positive integer). [More info...](BAD_URL_valentjn.github.io/ltex/settings.html#ltexsentencecachesize)
---
---```lua
---default = 2000
---```
