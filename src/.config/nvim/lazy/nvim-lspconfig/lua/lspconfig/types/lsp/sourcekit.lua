...
---Runtime [sanitizer instrumentation](BAD_URL_www.swift.org/documentation/server/guides/llvm-sanitizers.html).
---
---```lua
---default = "off"
---```
...
---The [Swift SDK](BAD_URL_github.com/swiftlang/swift-evolution/blob/main/proposals/0387-cross-compilation-destinations.md) to compile against (`--swift-sdk` parameter).
---
---```lua
---default = ""
---```
