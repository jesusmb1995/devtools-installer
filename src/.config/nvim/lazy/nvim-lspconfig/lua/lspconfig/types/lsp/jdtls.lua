...
---Specifies the url or file path to the [Eclipse formatter xml settings](BAD_URL_github.com/redhat-developer/vscode-java/wiki/Formatter-settings).
---@field url? string
...
---Specifies the url or file path to the workspace Java settings. See [Setting Global Preferences](BAD_URL_github.com/redhat-developer/vscode-java/wiki/Settings-Global-Preferences)
---@field url? string
...
---Enable usage data and errors to be sent to Red Hat servers. Read our [privacy statement](BAD_URL_developers.redhat.com/article/tool-data-collection).
---@field enabled? boolean
