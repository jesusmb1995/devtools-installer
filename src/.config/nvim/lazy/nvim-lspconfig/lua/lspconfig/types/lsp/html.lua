...
---List of tags, comma separated, that shouldn't be reformatted. `null` defaults to all tags listed at BAD_URL_www.w3.org/TR/html5/dom.html#phrasing-content.
---
---```lua
---default = "wbr"
---```
...
---A list of relative file paths pointing to JSON files following the [custom data format](BAD_URL_github.com/microsoft/vscode-html-languageservice/blob/master/docs/customData.md).
---
