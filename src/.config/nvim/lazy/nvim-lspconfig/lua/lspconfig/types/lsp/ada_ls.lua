...
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists. Otherwise it defaults to `false`.
...
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists. Otherwise it defaults to `true`.
...
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists.
...
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists. Otherwise it defaults to `"usage_and_abstract_only"`.
...
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists. Otherwise it defaults to `"gnat"`.
...
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists. Otherwise it defaults to `10`.
---
---```lua
---default = 10
---```
...
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists. Otherwise it defaults to `3`.
---
---```lua
---default = 3
---```
...
---The path to a directory used for out-of-tree builds. This feature is related to the [--relocate-build-tree GPRbuild command line switch](BAD_URL_docs.adacore.com/gprbuild-docs/html/gprbuild_ug/building_with_gprbuild.html#switches).
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists.
...
---
---It specifies the root directory for artifact relocation. It corresponds to the [--root-dir GPRbuild command line switch](BAD_URL_docs.adacore.com/gprbuild-docs/html/gprbuild_ug/building_with_gprbuild.html#switches).
---
---If not set in VS Code, this setting takes its value from the [`.als.json`](BAD_URL_github.com/AdaCore/ada_language_server/blob/master/doc/settings.md) file at the root of the workspace, if that file exists.
