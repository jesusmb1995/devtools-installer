...
---Specify glob patterns of files to exclude from auto imports. Relative paths are resolved relative to the workspace root. Patterns are evaluated using tsconfig.json [`exclude`](BAD_URL_www.typescriptlang.org/tsconfig#exclude) semantics.
...
---Sets the module system for the program. See more: BAD_URL_www.typescriptlang.org/tsconfig#module.
---
---```lua
---default = "ESNext"
---```
---@field module? "CommonJS" | "AMD" | "System" | "UMD" | "ES6" | "ES2015" | "ES2020" | "ESNext" | "None" | "ES2022" | "Node12" | "NodeNext"
---Enable/disable [strict mode](BAD_URL_www.typescriptlang.org/tsconfig#strict) in JavaScript and TypeScript files that are not part of a project. Existing `jsconfig.json` or `tsconfig.json` files override this setting.
---
---```lua
---default = true
---```
---@field strict? boolean
---Enable/disable [strict function types](BAD_URL_www.typescriptlang.org/tsconfig#strictFunctionTypes) in JavaScript and TypeScript files that are not part of a project. Existing `jsconfig.json` or `tsconfig.json` files override this setting.
---
---```lua
---default = true
---```
---@field strictFunctionTypes? boolean
---Enable/disable [strict null checks](BAD_URL_www.typescriptlang.org/tsconfig#strictNullChecks) in JavaScript and TypeScript files that are not part of a project. Existing `jsconfig.json` or `tsconfig.json` files override this setting.
---
---```lua
---default = true
---```
---@field strictNullChecks? boolean
---Set target JavaScript language version for emitted JavaScript and include library declarations. See more: BAD_URL_www.typescriptlang.org/tsconfig#target.
---
---```lua
---default = "ES2024"
---```
...
---
---See the [TypeScript documentation](BAD_URL_code.visualstudio.com/docs/typescript/typescript-compiling#_using-newer-typescript-versions) for more detail about managing TypeScript versions.
---@field path? string
...
---Enable [automatic type acquisition](BAD_URL_code.visualstudio.com/docs/nodejs/working-with-javascript#_typings-and-automatic-type-acquisition). Automatic type acquisition fetches `@types` packages from npm to improve IntelliSense for external libraries.
---
---```lua
---default = true
---```
...
---Specifies the path to the npm executable used for [Automatic Type Acquisition](BAD_URL_code.visualstudio.com/docs/nodejs/working-with-javascript#_typings-and-automatic-type-acquisition).
---@field path? string
...
---Check if npm is installed for [Automatic Type Acquisition](BAD_URL_code.visualstudio.com/docs/nodejs/working-with-javascript#_typings-and-automatic-type-acquisition).
---
---```lua
---default = true
---```
...
---Controls which files are searched by [Go to Symbol in Workspace](BAD_URL_code.visualstudio.com/docs/editor/editingevolved#_open-symbol-by-name).
---
---```lua
...
---Disables [automatic type acquisition](BAD_URL_code.visualstudio.com/docs/nodejs/working-with-javascript#_typings-and-automatic-type-acquisition). Automatic type acquisition fetches `@types` packages from npm to improve IntelliSense for external libraries.
