...
---The ESLint options object to use on save (see BAD_URL_eslint.org/docs/developer-guide/nodejs-api#eslint-class). `eslint.codeActionsOnSave.rules`, if specified, will take priority over any rule options here.
---
---```lua
---default = {}
---```
...
---@field enable? boolean
---Command line options applied when running the task for linting the whole workspace (see BAD_URL_eslint.org/docs/user-guide/command-line-interface).
---
---```lua
---default = "."
---```
...
---The eslint options object to provide args normally passed to eslint when executed from a command line (see BAD_URL_eslint.org/docs/developer-guide/nodejs-api#eslint-class).
---
---```lua
---default = {}
---```
...
---Controls whether flat config should be used or not. This setting requires ESLint version 8.57 or later and is interpreted according to the [ESLint Flat Config rollout plan](BAD_URL_eslint.org/blog/2023/10/flat-config-rollout-plans/). This means:
---
