...
---Unsupported use of the [`@apply` directive](BAD_URL_tailwindcss.com/docs/functions-and-directives/#apply)
---
---```lua
---default = "error"
---```
---@field invalidApply? "ignore" | "warning" | "error"
---Unknown or invalid path used with the [`theme` helper](BAD_URL_tailwindcss.com/docs/functions-and-directives/#theme)
---
---```lua
---default = "error"
---```
---@field invalidConfigPath? "ignore" | "warning" | "error"
---Unknown screen name used with the [`@screen` directive](BAD_URL_tailwindcss.com/docs/functions-and-directives/#screen)
---
---```lua
---default = "error"
---```
---@field invalidScreen? "ignore" | "warning" | "error"
---Unknown value used with the [`@tailwind` directive](BAD_URL_tailwindcss.com/docs/functions-and-directives/#tailwind)
---
---```lua
---default = "error"
---```
---@field invalidTailwindDirective? "ignore" | "warning" | "error"
---Unknown variant name used with the [`@variants` directive](BAD_URL_tailwindcss.com/docs/functions-and-directives/#variants)
---
---```lua
---default = "error"
---```
---@field invalidVariant? "ignore" | "warning" | "error"
---Class variants not in the recommended order (applies in [JIT mode](BAD_URL_tailwindcss.com/docs/just-in-time-mode) only)
---
---```lua
---default = "warning"
---```
