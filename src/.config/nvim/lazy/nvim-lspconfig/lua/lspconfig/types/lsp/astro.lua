...
---Enable the auto import cache. Yields a faster intellisense when automatically importing a file, but can cause issues with new files not being detected. Change is applied on restart. See [#1035](BAD_URL_github.com/withastro/language-tools/issues/1035).
---
---```lua
---default = true
---```
