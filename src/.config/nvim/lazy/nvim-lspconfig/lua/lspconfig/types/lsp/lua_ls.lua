...
---Read [formatter docs](BAD_URL_github.com/CppCXY/EmmyLuaCodeStyle/tree/master/docs) to learn usage.
---
---
---```lua
---default = {}
...
---[Command line parameters](BAD_URL_github.com/LuaLS/lua-telemetry-server/tree/master/method) when starting the language server in VSCode.
---
---```lua
---default = {}
---```
...
---Plugin path. Please read [wiki](BAD_URL_luals.github.io/wiki/plugins) to learn more.
...
---Add private third-party library configuration file paths here, please refer to the built-in [configuration file path](BAD_URL_github.com/LuaLS/lua-language-server/tree/master/meta/3rd)
---
---```lua
---default = {}
---```
