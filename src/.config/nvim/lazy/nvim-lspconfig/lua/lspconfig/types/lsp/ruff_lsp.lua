...
---Enable [preview mode](BAD_URL_docs.astral.sh/ruff/settings/#format_preview) for the formatter; enables unstable formatting.
---
...
---Set rule codes to disable. See [the documentation](BAD_URL_docs.astral.sh/ruff/settings/#lint_ignore) for more details.
---
---**This setting is used only by the native server.**
---@field ignore? string[]
---Enable [preview mode](BAD_URL_docs.astral.sh/ruff/settings/#lint_preview) for the linter; enables unstable rules and fixes.
---
---**This setting is used only by the native server.**
---@field preview? boolean
...
---Set rule codes to enable. Use `ALL` to enable all rules. See [the documentation](BAD_URL_docs.astral.sh/ruff/settings/#lint_select) for more details.
---
---**This setting is used only by the native server.**
---@field select? string[]
...
---Configuration overrides for Ruff. See [the documentation](BAD_URL_docs.astral.sh/ruff/editors/settings/#configuration) for more details.
---
---**This setting is used only by the native server.**
...
---Set paths for the linter and formatter to ignore. See [the documentation](BAD_URL_docs.astral.sh/ruff/settings/#lint_exclude) for more details.
---
---**This setting is used only by the native server.**
...
---Set the [line length](BAD_URL_docs.astral.sh/ruff/settings/#line-length) used by the formatter and linter. Must be greater than 0. Ruff 0.15.12 or older uses a maximum of 320.
---
---**This setting is used only by the native server.**
...
---Whether to use the native language server, [`ruff-lsp`](BAD_URL_github.com/astral-sh/ruff-lsp) or automatically decide between the two based on the Ruff version and extension settings.
---
---```lua
---default = "auto"
---```
