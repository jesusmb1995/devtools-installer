...
---Specific variety of English being written. See [this article](BAD_URL_support.grammarly.com/hc/en-us/articles/115000089992-Select-between-British-English-American-English-Canadian-English-and-Australian-English) for differences.
---
---```lua
---default = "auto-text"
---```
---@field documentDialect? "american" | "australian" | "british" | "canadian" | "auto-text"
---The style or type of writing to be checked. See [What is domain/document type](BAD_URL_support.grammarly.com/hc/en-us/articles/115000091472-What-is-domain-document-type-)?
---
---```lua
---default = "general"
---```
...
---Configure [glob patterns](BAD_URL_code.visualstudio.com/docs/editor/codebasics#_advanced-search-options) for excluding files and folders.
---
---```lua
---default = {}
---```
---@field exclude string[]
---Configure [glob patterns](BAD_URL_code.visualstudio.com/docs/editor/codebasics#_advanced-search-options) for including files and folders.
---
---```lua
