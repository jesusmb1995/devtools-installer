...
---```lua
---default = {
---  ["BAD_URL_developer.microsoft.com/json-schemas/"] = true,
---  ["BAD_URL_json-schema.org/"] = true,
---  ["BAD_URL_json.schemastore.org/"] = true,
---  ["BAD_URL_raw.githubusercontent.com/devcontainers/spec/"] = true,
---  ["BAD_URL_raw.githubusercontent.com/microsoft/vscode/"] = true,
---  ["BAD_URL_schemastore.azurewebsites.net/"] = true,
---  ["BAD_URL_www.schemastore.org/"] = true
---}
---```
