...
---Specifies sub-directories in [a package directory](BAD_URL_docs.julialang.org/en/v1/manual/code-loading/#Package-directories-1) where only basic linting is. This drastically lowers the chance for false positives.
---
---```lua
---default = { "docs", "test" }
---```
...
---
---```lua
---default = "BAD_URL_www.julia-vscode.org/symbolcache"
---```
...
---Display [progress bars](BAD_URL_github.com/JunoLab/ProgressLogging.jl) within VS Code.
---
---```lua
---default = true
---```
