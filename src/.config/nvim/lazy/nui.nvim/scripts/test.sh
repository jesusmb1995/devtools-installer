...
function setup_environment() {
  ...
  if [[ ! -d "${plugins_dir}/plenary.nvim" ]]; then
    ...
    echo "OFFLINE: no git clone" # git clone BAD_URL_github.com/nvim-lua/plenary.nvim "${plugins_dir}/plenary.nvim"
    # commit 9069d14a120cadb4f6825f76821533f2babcab92 broke luacov
    # issue: BAD_URL_github.com/nvim-lua/plenary.nvim/issues/353
