...
---     }
--- ```
--- see BAD_URL_github.com/NvChad/base46/tree/master/lua/base46/integrations
...
--- see BAD_URL_github.com/NvChad/base46/tree/master/lua/base46/themes for the colors of each theme
...
--- see BAD_URL_github.com/NvChad/base46/tree/master/lua/base46/themes
...
--- Check BAD_URL_github.com/NvChad/ui/blob/v2.5/lua/nvchad/stl/utils.lua#L12 for the modules of each statusline theme
---@field order? string[]
