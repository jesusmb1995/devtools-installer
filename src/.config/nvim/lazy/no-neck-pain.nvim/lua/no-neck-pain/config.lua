...
NoNeckPain.bufferOptionsScratchPad = {
    ...
    -- note: filetype is defaulted to `norg` (BAD_URL_github.com/nvim-neorg/neorg), but can be changed in `buffers.bo.filetype` or |NoNeckPain.bufferOptions| for option scoped to the `left` and/or `right` buffer.
    -- /!\ deprecated /!\ use `pathToFile` instead.
    ---@type string?
    ---@example: `no-neck-pain-left.norg`
    ---@deprecated: use `pathToFile` instead.
...
NoNeckPain.options = {
    ...
    ---@type table
    integrations = {
        -- @link BAD_URL_github.com/nvim-tree/nvim-tree.lua
        ---@type table
        NvimTree = {
        ...
        -- @link BAD_URL_github.com/nvim-neo-tree/neo-tree.nvim
        NeoTree = {
            -- The position of the tree.
            ---@type "left"|"right"
            position = "left",
        ...
        -- @link BAD_URL_github.com/mbbill/undotree
        undotree = {
            -- The position of the tree.
            ---@type "left"|"right"
            position = "left",
        },
        -- @link BAD_URL_github.com/nvim-neotest/neotest
        neotest = {
            -- The position of the tree.
            ---@type "right"
            position = "right",
        ...
        -- @link BAD_URL_github.com/rcarriga/nvim-dap-ui
        NvimDAPUI = {
            -- The position of the tree.
            ---@type "none"
            position = "none",
        ...
        -- @link BAD_URL_github.com/hedyhli/outline.nvim
        outline = {
            -- The position of the tree.
            ---@type "left"|"right"
            position = "right",
        ...
        -- @link BAD_URL_github.com/stevearc/aerial.nvim
        aerial = {
            -- The position of the tree.
            ---@type "left"|"right"
            position = "right",
        ...
        -- you can find the filetype list of natively supported dashboards here: BAD_URL_github.com/shortcuts/no-neck-pain.nvim/blob/main/lua/no-neck-pain/util/constants.lua#L82-L85
