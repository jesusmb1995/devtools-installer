...
You can customize them by adding your own styles to `opts.styles`.
      ...
      add([[Check the [styles](BAD_URL_github.com/folke/snacks.nvim/blob/main/docs/styles.md)
  ...
  for _, plugin in ipairs(plugins) do
    if plugin.meta.readme then
      lines[#lines + 1] = ("| %s | %s | %s |"):format(
        ("[%s](BAD_URL_github.com/folke/snacks.nvim/blob/main/docs/%s.md)"):format(plugin.name, plugin.name),
        plugin.meta.desc,
