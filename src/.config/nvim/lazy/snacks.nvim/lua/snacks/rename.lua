...
M.meta = {
  desc = "LSP-integrated file renaming with support for plugins like [neo-tree.nvim](BAD_URL_github.com/nvim-neo-tree/neo-tree.nvim) and [mini.files](BAD_URL_github.com/nvim-mini/mini.files).",
}
