...
M.sources = {
  nerd_fonts = {
    priority = 10,
    url = "BAD_URL_github.com/ryanoasis/nerd-fonts/raw/refs/heads/master/glyphnames.json",
    v = 4,
    build = function(data)
  ...
  emoji = {
    url = "BAD_URL_raw.githubusercontent.com/muan/unicode-emoji-json/refs/heads/main/data-by-emoji.json",
    priority = 20,
    v = 4,
    build = function(data)
