...
function M.get_selection_range(token)
  ...
  -- BAD_URL_microsoft.github.io/language-server-protocol/specification#textdocument_documentsymbol
...
--- BAD_URL_microsoft.github.io/language-server-protocol/specification/#range
