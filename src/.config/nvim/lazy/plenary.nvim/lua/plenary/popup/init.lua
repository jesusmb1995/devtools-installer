...
function popup.create(what, vim_options)
  ...
  -- noautocmd, undocumented vim default per BAD_URL_github.com/vim/vim/issues/5737
  ...
  if vim_options.wrap ~= nil then
    -- set_option wrap should/will trigger autocmd, see BAD_URL_github.com/neovim/neovim/pull/13247
