...
describe("CURL Wrapper:", function()
  describe("request", function() -----------------------------------------------
    it("sends and returns table.", function()
      eq(
        "table",
        type(curl.request {
          url = "BAD_URL_postman-echo.com/get",
          method = "get",
    ...
    it("should accept the url as first argument.", function()
      local res = curl.get("BAD_URL_postman-echo.com/get", {
        accept = "application/json",
      })
      eq(200, res.status)
    end)
  ...
  describe("GET", function() --------------------------------------------------
    ...
    it("sends encoded URL query params.", function()
      ...
      local response = curl.get("BAD_URL_postman-echo.com/get", {
        query = query,
      })
    ...
    it("downloads files to opts.output synchronously", function()
      local file = "BAD_URL_media2.giphy.com/media/bEMcuOG3hXVnihvB7x/giphy.gif"
    ...
    it("downloads files to to opts.output asynchronous", function()
      ...
      local succ = nil
      local done = false
      local file = "BAD_URL_media2.giphy.com/media/notvalid.gif"
    ...
    it("sends with basic-auth as string", function()
      local url = "BAD_URL_postman-echo.com/basic-auth"
      local auth, res
  ...
  describe("POST", function() --------------------------------------------------
    it("sends raw string", function()
      local res = curl.post("BAD_URL_postman-echo.com/post", {
        body = "John Doe",
      })
    ...
    it("sends lua table", function()
      local res = curl.post("BAD_URL_jsonplaceholder.typicode.com/posts", {
        body = {
          title = "Hello World",
          body = "...",
        },
  ...
  describe("PUT", function() --------------------------------------------------
    it("sends changes and get be back the new version.", function()
      ...
      local res = curl.put("BAD_URL_jsonplaceholder.typicode.com/posts/8", {
        body = cha,
      })
  ...
  describe("PATCH", function() ------------------------------------------------
    it("sends changes and get be back the new version.", function()
      local cha = { title = "New Title" }
      local res = curl.patch("BAD_URL_jsonplaceholder.typicode.com/posts/8", {
        body = cha,
      })
      eq(cha.title, vim.fn.json_decode(res.body).title)
      eq(200, res.status)
  ...
  describe("DELETE", function() ------------------------------------------------
    it("sends delete request", function()
      local res = curl.delete "BAD_URL_jsonplaceholder.typicode.com/posts/8"
      eq(200, res.status)
    end)
  end)
  ...
  describe("DEBUG", function() --------------------------------------------------
    it("dry_run return the curl command to be ran.", function()
      local res = curl.delete("BAD_URL_jsonplaceholder.typicode.com/posts/8", { dry_run = true })
