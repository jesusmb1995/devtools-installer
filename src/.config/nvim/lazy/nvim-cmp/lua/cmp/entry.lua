...
entry._set_completion_item = function(self, completion_item)
  if not self.completion_item then
    ...
    -- @see BAD_URL_github.com/microsoft/vscode/blob/85eea4a9b2ccc99615e970bf2181edbc1781d0f9/src/vs/workbench/api/browser/mainThreadLanguageFeatures.ts#L588
    -- @see BAD_URL_github.com/microsoft/vscode/blob/85eea4a9b2ccc99615e970bf2181edbc1781d0f9/src/vs/base/common/objects.ts#L89
    -- @see BAD_URL_github.com/microsoft/vscode/blob/a00f2e64f4fa9a1f774875562e1e9697d7138ed3/src/vs/editor/contrib/suggest/browser/suggest.ts#L147
...
entry.match = function(self, input, matching_config)
  -- BAD_URL_www.lua.org/pil/11.6.html
