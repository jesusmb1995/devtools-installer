...
-- that expose snippets in json files, for example <BAD_URL_github.com/rafamadriz/friendly-snippets>.

require("luasnip.loaders.from_vscode").load({ include = { "python" } }) -- Load only python snippets

-- The directories will have to be structured like eg. <BAD_URL_github.com/rafamadriz/friendly-snippets> (include
...
-- You can also use snippets in snipmate format, for example <BAD_URL_github.com/honza/vim-snippets>.
