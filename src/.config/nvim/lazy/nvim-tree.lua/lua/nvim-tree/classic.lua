...
--
-- BAD_URL_github.com/rxi/classic
--


---@brief
---
---nvim-tree uses the BAD_URL_github.com/rxi/classic class framework adding safe casts, instanceof mixin and conventional destructors.
---
