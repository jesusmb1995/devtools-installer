...
local function removed_config(u)
  if u.auto_close then
    require("nvim-tree.notify").warn(
      "auto close feature has been removed: BAD_URL_github.com/nvim-tree/nvim-tree.lua/wiki/Auto-Close"
    )
    u["auto_close"] = nil
  end
  ...
  if u.focus_empty_on_setup then
    require("nvim-tree.notify").warn(
      "focus_empty_on_setup has been removed: BAD_URL_github.com/nvim-tree/nvim-tree.lua/wiki/Open-At-Startup"
    )
