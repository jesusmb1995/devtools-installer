...
function Explorer:reload(node, project)
  ...
  while true do
    ...
    -- path incorrectly specified as an integer, fixed upstream for neovim 0.12 BAD_URL_github.com/neovim/neovim/pull/33872
...
function Explorer:force_dirchange(foldername, should_open_view, should_init)
  ...
  if should_open_view then
    ...
    -- Problem is described at BAD_URL_github.com/nvim-tree/nvim-tree.lua/pull/3233#issuecomment-3704402527
